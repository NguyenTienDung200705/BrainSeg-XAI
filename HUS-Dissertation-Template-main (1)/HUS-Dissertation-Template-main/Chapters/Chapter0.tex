...
Tiểu luận này trình bày thiết kế và triển khai hệ thống BrainSeg-XAI -- một hệ thống trí tuệ nhân tạo hỗ trợ chẩn đoán u não từ ảnh MRI, kết hợp khả năng phân đoạn vùng khối u tự động với cơ chế giải thích kết quả dự đoán có thể hiểu được. Hệ thống được xây dựng dựa trên kiến trúc học sâu U-Net và U-Net++, tích hợp kỹ thuật Gradient-weighted Class Activation Mapping (Grad-CAM) để trực quan hóa lý do mô hình đưa ra quyết định, và một bộ máy luật y khoa để đánh giá mức độ rủi ro lâm sàng.

Cấu trúc tiểu luận được tổ chức theo trình tự logic từ nền tảng lý thuyết đến hiện thực kỹ thuật và đánh giá kết quả:
