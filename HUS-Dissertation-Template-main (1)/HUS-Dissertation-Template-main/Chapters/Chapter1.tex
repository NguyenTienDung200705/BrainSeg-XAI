...
\begin{figure}[h!]
    ...
    \caption{Ví dụ một mẫu từ bộ dữ liệu LGG MRI Segmentation \cite{Buda2019}: ảnh MRI gốc (trái), mặt nạ nhị phân do chuyên gia chú thích (giữa) và overlay vùng khối u trên ảnh gốc (phải).}
